...
#### This is a summary of all users’ requirements – as the intention is to develop a single shared database, the database should store the following information: ####
* Patient: 
